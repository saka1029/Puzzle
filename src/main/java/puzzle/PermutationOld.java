...
public class PermutationOld {
    ...
    private static boolean primitiveNext(int[] array) {
    ...
    public static class EqualsComparator<T> implements Comparator<T> {

        final Map<T, Integer> map = new HashMap<>();

        public EqualsComparator(T[] array) {
            int[] i = {0};
            for (T e : array)
