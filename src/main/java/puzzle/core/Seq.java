...
public interface Seq<T> extends List<T> {
    ...
    public static Seq<Integer> ofInt(int... elements) {
        return new ListSeq<>(Arrays.stream(elements).boxed().collect(Collectors.toList()));
    }

    public static Seq<Long> ofLong(long... elements) {
        return new ListSeq<>(Arrays.stream(elements).boxed().collect(Collectors.toList()));
    }

    public static Seq<Double> ofDouble(double... elements) {
        return new ListSeq<>(Arrays.stream(elements).boxed().collect(Collectors.toList()));
    }

    public static Seq<Byte> ofByte(byte... elements) {
    ...
    public static Seq<Short> ofShort(short... elements) {
        int length = elements.length;
    ...
    public static Seq<Character> ofChar(char... elements) {
        int length = elements.length;
    ...
    public static Seq<Float> ofFloat(float... elements) {
        int length = elements.length;
