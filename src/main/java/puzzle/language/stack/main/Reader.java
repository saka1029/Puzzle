package puzzle.language.stack.main;

import java.io.IOException;
import java.util.Map;
import java.util.regex.Pattern;

import puzzle.language.stack.core.Context;
import puzzle.language.stack.values.Bool;
import puzzle.language.stack.values.Chars;
import puzzle.language.stack.values.Int;
import puzzle.language.stack.values.List;
import puzzle.language.stack.values.Real;
import puzzle.language.stack.values.Value;
