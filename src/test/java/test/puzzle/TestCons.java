...
class TestCons {
    ...
    public void testHeadTail() {
        ...
        assertEquals(1, clist.head());
        assertEquals(2, clist.tail().head());
        assertEquals(3, clist.tail().tail().head());
        assertEquals(4, clist.tail().tail().tail().head());
    ...
    public void testGet() {
        CList<Integer> clist = CList.of(1, 2, 3, 4);
        assertEquals(1, clist.get(0));
        assertEquals(2, clist.get(1));
        assertEquals(3, clist.get(2));
        assertEquals(4, clist.get(3));
    }
    ...
    public void testIterable() {
        ...
        assertTrue(it.hasNext()); assertEquals(1, it.next());
        assertTrue(it.hasNext()); assertEquals(2, it.next());
        assertTrue(it.hasNext()); assertEquals(3, it.next());
        assertTrue(it.hasNext()); assertEquals(4, it.next());
