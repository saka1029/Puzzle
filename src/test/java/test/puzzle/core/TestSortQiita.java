...
public class TestSortQiita {
    ...
    @Test
    public void testSortIntArrayReverseBoxed() {
        int[] ints = {4, 5, 2, 6, 1, 3, 7, 0};
    ...
    @Test
    public void testSortIntArrayReverseNegative() {
        int[] ints = {4, 5, 2, 6, 1, 3, 7, 0};
        int[] reverse = IntStream.of(ints)
            .map(i -> -i)
            .sorted()
    ...
    @Test
    public void testSortIntArrayReverseNegativeMinValue() {
    ...
    @Test
    public void testSortIntArrayReverseNotMinValue() {
        int[] ints = {Integer.MIN_VALUE, 5, 2, 6, 1, 3, 7, 0};
        int[] reverse = IntStream.of(ints)
            .map(i -> ~i)
            .sorted()
